...
| `14_present-worldview.md` | 165–190 | 现在 · 世界观 | 6 |
| `20_encounters-with-user.md` | 200–299 | 现在 · 与用户的相遇与事件 | 0（占位） |
...
| `99_forms-of-address.md` | 990–995 | 称呼（after_char） | 2 |
...
| 层 | 组 | order 段 | 说明 |
|---|---|---|---|
| 0 | 现在 · 临空市与当下 | 100–199 | 他此刻生活、工作、持有的一切 |
| 1 | 现在 · 与用户的相遇与事件 | 200–299 | **待整理** |
